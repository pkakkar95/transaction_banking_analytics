...
<script type="text/javascript" src="creategraph2.js"></script>
<div id="main" display=none>
<div class="wrapper">
  <h1>Transaction Banking Analytics</h1>
  <button class="button"><a href="NewFile.jsp">Next</a></button>
  <button class="button"><a href="v1.jsp">Back</a></button>
   <div class="half">
    <div class="tab">
